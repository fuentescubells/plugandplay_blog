...
export default async function BlogHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 w-full border-b border-neutral-200 bg-white/80 backdrop-blur-sm dark:border-neutral-800 dark:bg-neutral-950/80">
      <div className="relative mx-auto max-w-7xl flex h-16 items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">

        <HamburgerMenu categories={categories} />

        <Link href="/" className="absolute left-1/2 -translate-x-1/2 shrink-0 text-xl font-bold tracking-tight text-neutral-900 dark:text-neutral-50 lg:static lg:translate-x-0">
          LOGO
        </Link>
